...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <div class="row">
           <label for="">rửa chén <input type="checkbox" name="loai" value ="1" onchange="getProductTypecare(value)" id="ruachen"></label>
           <label for="">máy móc <input type="checkbox" name="loai"value = "0" onchange="" id=""></label>
